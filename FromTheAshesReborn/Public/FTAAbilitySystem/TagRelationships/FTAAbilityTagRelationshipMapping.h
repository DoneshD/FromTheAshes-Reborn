...
#include "FTAAbilityTagRelationshipMapping.generated.h"

class UObject;

USTRUCT()
struct FFTAAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class FROMTHEASHESREBORN_API UFTAAbilityTagRelationshipMapping : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FFTAAbilityTagRelationship> AbilityTagRelationships;
