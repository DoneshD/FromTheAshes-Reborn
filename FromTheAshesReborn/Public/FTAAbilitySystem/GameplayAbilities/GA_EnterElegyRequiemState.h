...
#include "GA_EnterElegyRequiemState.generated.h"

UCLASS()
class FROMTHEASHESREBORN_API UGA_EnterElegyRequiemState : public UFTAGameplayAbility
{
	GENERATED_BODY()

protected:
	
	UGA_EnterElegyRequiemState();
